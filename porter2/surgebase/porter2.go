...
// NOTICE OF MODIFICTATION
// In compliance with the Apache 2.0 license, this notice is to inform the reader
// that this file has been modified from it's original form.
// Changes include:
// The name of the package
// The input and output types of the stem function
// The addition of a main function
// To see the original see: https://github.com/surgebase/porter2/
...
func stem(str *C.char) *C.char {
	...
	return C.CString(string(postlude(step5(step4(step3(step2(step1c(step1b(rs, r1)), r1), r1, r2), r2), r1, r2))))
}
